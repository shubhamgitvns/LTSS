...
import 'package:recharge_setu/user_page/report_page/prepaid_report/prepaid_complent.dart';
import 'package:recharge_setu/user_page/report_page/prepaid_report/prepaid_share.dart';
...
class prepaid_Report extends StatefulWidget {
  const prepaid_Report({super.key});

  @override
  State<prepaid_Report> createState() => _prepaid_ReportState();
}

class _prepaid_ReportState extends State<prepaid_Report> {
  @override
                                ...
                                onTap: (){
                                  Navigator.push(
                                    ...
                                    PageTransition(
                                      type: PageTransitionType.topToBottom,
                                      isIos: true,
                                      child: const Prepaid_Transaction_Slip(),
                                    ),
                                  );
                                },
                              )
