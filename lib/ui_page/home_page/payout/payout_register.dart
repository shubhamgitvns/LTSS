...
import 'package:recharge_setu/ui_page/home_page/payout/payout_otp_veryfication.dart';

import '../../../app_text.dart';

class Payout_Register extends StatefulWidget {
  const Payout_Register({super.key});

  @override
  State<Payout_Register> createState() => _Payout_RegisterState();
}

class _Payout_RegisterState extends State<Payout_Register> {
  @override
                ...
                onTap: (){
                  Navigator.push(
                    ...
                    PageTransition(
                      ...
                      isIos: true,
                      child: const Payout_OTP_Veryfication(),
                    ),
                  );
                },
              )
