...
import 'package:recharge_setu/ui_page/home_page/upi/upi_otp_varification.dart';

import '../../../app_text.dart';

class UPI_Register extends StatefulWidget {
  const UPI_Register({super.key});

  @override
  State<UPI_Register> createState() => _UPI_RegisterState();
}

class _UPI_RegisterState extends State<UPI_Register> {
  @override
                ...
                onTap: (){
                  Navigator.push(
                    ...
                    PageTransition(
                      ...
                      isIos: true,
                      child: const UPI_OTP_Veryfication(),
                    ),
                  );
                },
              )
