...
import 'csc_otp_veryfication.dart';
class Csc_Register extends StatefulWidget {
  const Csc_Register({super.key});

  @override
  State<Csc_Register> createState() => _Csc_RegisterState();
}

class _Csc_RegisterState extends State<Csc_Register> {
  @override
                ...
                onTap: (){
                  Navigator.push(
                    ...
                    PageTransition(
                      ...
                      isIos: true,
                      child: const Csc_OTP_Veryfication(),
                    ),
                  );
                },
              )
