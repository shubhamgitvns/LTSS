...
class Card_Transaction extends StatefulWidget {
  const Card_Transaction({super.key});

  @override
  State<Card_Transaction> createState() => _Card_TransactionState();
}

class _Card_TransactionState extends State<Card_Transaction> {
  bool recharge=false;
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text("Card Transactions",style: Text_Style.App,),
        actions: const [
          Padding(
                  ...
                  children: [
                    Column(
                      children: [
                        ...
                        const Row(
                          children: [
                            Text("Total",style: TextStyle(color: Colors.red,fontWeight: FontWeight.bold),),
                          ],
                        ),
                        ...
                        const Row(
                          children: [
                            Text("Charges",style: TextStyle(color: Colors.red,fontWeight: FontWeight.bold),),
                          ],
                        ),
                        const SizedBox(height: 5,),
                        Row(
      ...
      child: Row(
        ...
        children: [
          SizedBox(
            width: 160,
            child: ListTile(
              title: const Text('Online',style: TextStyle(color: Colors.red),),
          ...
          SizedBox(
            width: 150,
            child: ListTile(
              title: const Text('Pos',style: TextStyle(color: Colors.red),),
              leading: Radio<SingingCharacter>(
