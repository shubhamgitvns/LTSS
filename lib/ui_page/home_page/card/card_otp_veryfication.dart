...
class Card_OTP_Veryfication extends StatefulWidget {
  const Card_OTP_Veryfication({super.key});

  @override
  State<Card_OTP_Veryfication> createState() => _Card_OTP_VeryficationState();
}

class _Card_OTP_VeryficationState extends State<Card_OTP_Veryfication> {
