...
class Dish_Tv_Recharge extends StatefulWidget {
  const Dish_Tv_Recharge({super.key});

  @override
  State<Dish_Tv_Recharge> createState() => _Dish_Tv_RechargeState();
}

class _Dish_Tv_RechargeState extends State<Dish_Tv_Recharge> {
  bool recharge=false;
  @override
